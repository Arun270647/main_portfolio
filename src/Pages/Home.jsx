...
const StatusBadge = memo(() => (
  <div className="inline-block animate-float lg:mx-10" data-aos="zoom-in" data-aos-delay="400">
...
const MainTitle = memo(() => (
  <div className="space-y-6 lg:mx-10" data-aos="fade-up" data-aos-delay="600">
...
const TechStack = memo(({ tech }) => (
  <div className="px-6 py-2 hidden sm:block rounded-full bg-white/5 backdrop-blur-sm border border-white/10 text-sm text-gray-300 hover:bg-white/10 transition-colors">
    {tech}
  </div>
));
