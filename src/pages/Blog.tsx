  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://arunvignesh.my/blog" />
        ...
        <meta property="og:url" content="https://arunvignesh.my/blog" />
        ...
        <script type="application/ld+json">
          {JSON.stringify(webPageSchema({
            ...
            url: "https://arunvignesh.my/blog"
          }))}
        </script>
        <script type="application/ld+json">
          {JSON.stringify(breadcrumbSchema([
            { name: "Home", url: "https://arunvignesh.my" },
            { name: "Blog", url: "https://arunvignesh.my/blog" }
          ]))}
        </script>
      </Helmet>
