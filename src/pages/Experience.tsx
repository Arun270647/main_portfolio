    ...
    return (
        <Layout breadcrumbs={[{ label: 'Experience' }]}>
            <Helmet>
                ...
                <link rel="canonical" href="https://www.arunvignesh.my/experience" />
                ...
                <meta property="og:url" content="https://www.arunvignesh.my/experience" />
                ...
                <script type="application/ld+json">
                    {JSON.stringify(webPageSchema({
                        ...
                        url: "https://www.arunvignesh.my/experience"
                    }))}
                </script>
                <script type="application/ld+json">
                    {JSON.stringify(breadcrumbSchema([
                        { name: "Home", url: "https://www.arunvignesh.my" },
                        { name: "Experience", url: "https://www.arunvignesh.my/experience" }
                    ]))}
                </script>
            </Helmet>
            <ExperienceSection />
